...
# Objective:  
This project demonstrates a basic interface between the VSD Squadron Mini Board and OLED. Here we are using the CH32V003F4U6 microcontroller to interface with a 128x64 OLED display using the I2C protocol. Our focus is to intialize OLED module using I2C protocol with full screen turning-on.
